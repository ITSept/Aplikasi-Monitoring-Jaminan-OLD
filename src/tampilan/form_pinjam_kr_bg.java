...
public final class form_pinjam_kr_bg extends javax.swing.JInternalFrame {
    ...
    public void dataTable2() {
        ...
        String sql = "select * from tb_kr_bg where no_pinjaman_bg desc";        
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
                ...
                String[] data = {"", no_pinjaman_bg, nama_debitur_bg};
    ...
    private void initComponents() {
        ...
        jScrollPane5.setViewportView(tbl_data_peminjaman);
        ...
        jScrollPane6.setViewportView(data_marketing);
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(txt_nama_marketing, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                ...
                                .addComponent(cari_nama_debitur, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        setSize(new java.awt.Dimension(1293, 641));
    ...
    private void cari_nasabahKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cari_nasabahKeyTyped
        String sqlPencarian2 = "select * from tb_kr_bg where no_pinjaman_bg like '%" + cari_nasabah.getText() + "%' or "
        + "nama_debitur_bg like '%" + cari_nasabah.getText() + "%'"; 
