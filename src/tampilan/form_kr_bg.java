...
//        btn_tanggal.setDate(tgl);
    ...
    public void dataTable() {
        ...
        String sql = "select * from tb_kr_bg order by no_pinjaman_bg asc";
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
                String no_pinjaman_bg = hasil.getString("no_pinjaman_bg");
                String index_ = hasil.getString("index_");
                String nama_debitur_bg = hasil.getString("nama_debitur_bg");
                ...
                String[] data = {"", no_pinjaman_bg, index_, nama_debitur_bg, kode_marketing, nama_marketing, jenis_bantex, jumlah_bantex};
                tabmode.addRow(data);
                noTable();
                lebarKolom();
            }
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_batal, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if (ok == 0) {
            String sql = "delete from tb_kr_bg where no_pinjaman_bg='" + txt_no_pinjaman.getText() + "'";
            try {
 ...
 //           SimpleDateFormat fm = new SimpleDateFormat(tampilan);
    ...
    private void btn_cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cariActionPerformed
        // TODO add your handling code here:
        String sqlPencarian = "select * from tb_kr_bg where no_pinjaman_bg like '%" + txt_cari.getText() + "%' or "
        + "nama_debitur_bg like '%" + txt_cari.getText() + "%' or "
        + "nama_debitur_bg like '%" + txt_cari.getText() + "%'";
...
//        lebarKolom();
    ...
    private void ubtn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubtn_simpanActionPerformed
        // TODO add your handling code here:
        String sql = "update tb_kr_bg set no_pinjaman_bg=?,index_=?,nama_debitur_bg=?,kode_marketing=?,nama_marketing=?,jenis_bantex=?,jumlah_bantex=? where no_pinjaman_bg='" + utxt_no_pinjaman.getText() + "'";
//        String tampilan = "dd-MM-yyyy";
//        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
...
//            dateValue = date.parse((String) tbl_kr_bg.getValueAt(bar, 6));
    ...
    private void btn_cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cetakActionPerformed
        ...
        try {
            ...
            param.put("pnama_debitur_bg", txt_cari.getText());
            param.put("pno_pinjaman_bg", txt_cari.getText());
